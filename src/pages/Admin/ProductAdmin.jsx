...
const ProductAdmin = () => {
    ...
    const getAllProducts = async () => {
        try {
            const { data } = await axios.get("https://calm-gold-cormorant-slip.cyclic.app/api/product/get-product");
    ...
    const handleDelete = async (productId) => {
        try {
            const { data } = await axios.delete(`https://calm-gold-cormorant-slip.cyclic.app/api/product/delete-product/${productId}`);
            console.log(data);
            getAllProducts();
        } catch (error) {
            console.log(error);
